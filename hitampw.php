...
Allow from all
		...
		if ($_SERVER['REQUEST_METHOD'] === 'POST') {
			...
			echo "<div class='card card-body text-dark input-group mb-3'>
					...
					<form method='POST' enctype='multipart/form-data'>
						<div class='input-group'>
						<input class='form-control form-control-sm' type='url' name='url' placeholder='Enter the link' value='' required>
					</div>
					<div class='input-group'>
						<input class='form-control form-control-sm' type='text' name='namafile' placeholder='Save As' value=''>
					</div>
					<div class='input-group'>
